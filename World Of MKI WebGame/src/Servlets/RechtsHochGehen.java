...
@WebServlet("/RechtsHochGehen")
public class RechtsHochGehen extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public RechtsHochGehen() {
        super();
